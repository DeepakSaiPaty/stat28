...
```{r}
# Insert your code here and save the t-statistic for the intercept as 
# `tstat.beta0`
# tstat.beta0 <- 
# tstat.beta0
# Insert your code here and save the t-statistic for the slope as 
# `tstat.beta1`
# tstat.beta1 <- 
# tstat.beta1
```

(c) Calculate the p-value of for the intercept and the slope using the test statistics you get in (b). What are the null hypothesis and your conclusion? Please use the normal distribution to approximate the distribution of test statistics under the null. Are your results consistent with the ones given in the summary?

```{r}
# Insert your code here and save the p-value for the intercept as 
# `pvalue.beta0`
# pvalue.beta0 <- 
# pvalue.beta0
# Insert your code here and save the t-statistic for the slope as 
...
```{r}
# Insert your code here and save the confidence interval for the intercept as 
# `confint.beta0`
# confint.beta0 <- 
# confint.beta0
# Insert your code here and save the confidence interval for the slope as 
# `confint.beta1`
# confint.beta1 <- 
# confint.beta1
```
...
```{r}
# Insert your code here and save the coefficients vector as 
# `coef.r`
# coef.r <- 
# coef.r
```
...
```{r}
# Insert your code here and save the confidence intervals as 
# `confint.r`
# confint.r <- 
# confint.r
```
...
```{r}
# Insert your code here and save the coefficients vector and prediction error as 
# `pred.2013` and `error.2013`
# pred.2013 <- 
# pred.2013
# error.2013 <- 
# error.2013
# Insert your code here and save the coefficients vector and prediction error as 
# `pred.2015` and `error.2015`
# pred.2015 <- 
# pred.2015
# error.2015 <- 
# error.2015
...
(d) Get the prediction intervals of `data science r` search index on "2013-01-06" (time point 435) and "2015-01-04"(time point 1163), using function `predict`. Do your perdiction intevals contains the actual values? 
...
**Exercise 3.** As you may discover, the linear model is not quite good for your dataset. In this exercise, you will fit a cubic curve to the data (use time to predict `r` and `python`). You may want to refer to the code in Page 23 and 24 in Lecture 3.
